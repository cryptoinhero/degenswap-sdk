...
(function (ChainId) {
  ...
  ChainId[ChainId["TESTNET"] = 4002] = "TESTNET";
...
var FACTORY_ADDRESS = '0xA01C3d760738c79e10334408aE59684Aa36B1131';
var INIT_CODE_HASH = '0xce42ffbf8ba32d0edc0fbbe04684ac4ec2aef8c480d3af1e196a5f80543e661a';
...
var FEES_NUMERATOR = /*#__PURE__*/JSBI.BigInt(9990);
...
Currency.ETHER = /*#__PURE__*/new Currency(18, 'FTM', 'Wrapped Fantom');
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83', 18, 'WFTM', 'Wrapped Fantom', 'https://fantom.foundation/'), _WETH[exports.ChainId.TESTNET] = /*#__PURE__*/new Token(exports.ChainId.TESTNET, '0x1b8733Bc06258e6201A56b080EA20D7BD4607d91', 18, 'WFTM', 'Wrapped Fantom', 'https://fantom.foundation/'), _WETH);
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'HAUS-LP', 'Degen Haus LP');
    ...
    if (!feeOn) {
      ...
      if (!JSBI.equal(kLastParsed, ZERO)) {
        ...
        if (JSBI.greaterThan(rootK, rootKLast)) {
          ...
          var denominator = JSBI.add(JSBI.multiply(rootK, TWO), rootKLast);
...
var TOKEN_DECIMALS_CACHE = (_TOKEN_DECIMALS_CACHE = {}, _TOKEN_DECIMALS_CACHE[exports.ChainId.MAINNET] = {
  '0x9ba3e4f84a34df4e08c112e1a0ff148b81655615': 9 // SHIBA
